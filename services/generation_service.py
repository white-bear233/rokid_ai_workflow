...
class GenerationService:
    ...
    def __init__(self):
        ...
        # 使用 qwen-max：生成内容更丰富、更详细，适合 AI 导览场景
        self.model = "qwen-max"
        # 使用通义千问文本生成 API
    ...
    async def generate_stream(
        ...
        system_prompt = (
            ...
            "【回答要求】：\n"
            "1. 优先从[参考资料]中提取能够直接回答用户问题的信息。\n"
            "2. 如果资料中没有明确答案，请结合资料为用户介绍一下眼前的这个【核心主体】的背景知识，"
            "并委婉告知暂未查到具体细节。\n"
            "3. 直接输出回答，语气要像一个贴心的真人导游，自然流畅，严禁出现"
            "\"根据参考资料1\"、\"搜索引擎显示\"等机械式话术。\n"
            f"4. 要求字数控制在180字以内，语气要符合{user_mode}的风格（{tone}）。"
        )
